...
rm -Rf ./results/supercells_integers_0_1_-1/tol_1_equal_to_10
mkdir -p  ./results/supercells_integers_0_1_-1/tol_1_equal_to_10

cd ./results/supercells_integers_0_1_-1/tol_1_equal_to_10
